...
<main id="mainContent" class="main homePage min-h-screen bg-brand-light dark:bg-brand-dark flex flex-col font-sans text-sm" data-pg="HomePage">
  ...
  <section class="relative w-full bg-white dark:bg-brand-dark/90 py-12 px-4 md:px-12 transition-all duration-500 overflow-hidden">
    <div class="absolute inset-0 z-0">
      <img src="/assets/logo.png" alt="Assurance Bank Logo" class="absolute left-1/2 top-1/2 w-96 max-w-full opacity-10 -translate-x-1/2 -translate-y-1/2 pointer-events-none select-none transition-all duration-1000" id="hero-bg-logo" />
    ...
    <div class="max-w-5xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white dark:bg-brand-dark rounded-xl shadow-lg p-6 flex flex-col items-center text-center">
          ...
          <p class="text-brand-gray dark:text-brand-light mb-3">“Switching to Assurance Bank was the best decision for my family. The process was smooth and the rates are unbeatable.”</p>
