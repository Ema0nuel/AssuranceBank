import{n as t}from"./navbar-BIr1TaOR.js";import{f as s}from"./footer-DTbUeEss.js";import{r as i}from"./reset-CYKpHJhn.js";import"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";const c=()=>{const e=t();i("Accessibility");function a(){e.pageEvents()}return{html:`
      ${e.html}
          ...
          <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <div class="text-brand-navy dark:text-brand-sun mb-4">
                <p>At Assurance Bank, we value all abilities and capabilities. We want our products, services and workplace to be accessible to all people. Using industry expertise and advances ensures banking with us is positive and seamless.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="py-8">
          <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="text-brand-gray dark:text-brand-light space-y-4">
              <p>We're committed to creating an inclusive and supportive bank for our customers, staff and community. The Assurance Bank Access and Inclusion Plan aims to do this.</p>
      ...
      ${s().html}
    `,pageEvents:a}};export{c as default};
