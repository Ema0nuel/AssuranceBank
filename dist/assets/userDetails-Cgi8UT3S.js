import{s as e}from"./supabaseClient-BzAKCqO5.js";import{A as m}from"./AdminNavbar-D-kZqzSj.js";import{r as u}from"./adminAuth-WhKi00aa.js";import{s as b}from"./toast-DRvdR0y9.js";import"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";const y=async t=>{if(!await u())return;const{data:i}=await e.from("profiles").select("*").eq("id",t).single(),{data:d}=await e.from("accounts").select("*").eq("user_id",t).single(),{data:o}=await e.from("kyc_requests").select("*").eq("user_id",t).order("created_at",{ascending:!1}).limit(1).single(),{data:l}=await e.from("transactions").select("*").eq("user_id",t).order("created_at",{ascending:!1}).limit(10);return{html:`
      ${m("users")}
