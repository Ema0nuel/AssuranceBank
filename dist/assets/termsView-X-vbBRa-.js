import{n as a}from"./navbar-BIr1TaOR.js";import{f as o}from"./footer-DE4WXhqK.js";import{r as s}from"./reset-CYKpHJhn.js";import{N as n}from"./logo-nobg-UuYbhWoI.js";import{L as i}from"./logo-B-uS21Zh.js";const h=()=>{const e=a();s("Terms of Use");function t(){e.pageEvents()}return{html:`
      ${e.html}
      <main id="mainContent" class="main fullWidthPage bg-brand-light dark:bg-brand-dark text-brand-navy dark:text-brand-light" data-pg="FullWidthPage">
        ...
        <section class="py-8">
          <div class="max-w-5xl mx-auto px-4">
            ...
            <p>Products and services displayed or offered on this Website contain general information about Assurance Bank products and services and can be changed by us at any time at our discretion. In the event of any conflict or inconsistency between this Website and the applicable disclosure document (such as a Product Disclosure Statement), the applicable disclosure document will take precedence. The information on this Website:</p>
            <ol class="list-decimal pl-6 mb-4">
              ...
              <li>does not form part of the terms and conditions for Assurance Bank products and services; and</li>
            ...
            <p>Links from this Website to third party websites, or references to products, services or publications other than those of Assurance Bank, do not imply the endorsement or approval of such third party websites, products, services or publications by Assurance Bank. Any access and use you make of such third party material is entirely at your own risk.</p>
            <p>The opinions or views that Assurance Bank makes available via third party websites or social media providers (such as videos or tweets) (each, a “<strong>Publication</strong>”) are not necessarily the opinions or views of Assurance Bank, and Assurance Bank makes no representation and gives no warranty as to the accuracy, currency or completeness of material contained in any Publication. Assurance Bank does not accept any responsibility to inform you of any matter that subsequently comes to their notice which may affect the accuracy, currency or completeness of the material in any of the Publications.</p>
          </div>
        </section>
      </main>
      ${o().html}
