import{s as n}from"./supabaseClient-BzAKCqO5.js";import{A as w}from"./AdminNavbar-D-kZqzSj.js";import{r as E}from"./adminAuth-WhKi00aa.js";import{s as u}from"./toast-DRvdR0y9.js";import{s as v}from"./sendEmail-89Z52C2k.js";import{s as $}from"./signupHandler-DkNH8CFo.js";import"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";import"./email-CEApoU8E.js";const f="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1oZnNvemNnaXZhZHF0bXZ1cm1oIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NTM5NDA5OCwiZXhwIjoyMDgwOTcwMDk4fQ.Jxqc2Zf0y0zK6H84pC-_RewiByzG6e7p5NFVLrXhM6o",I="https://mhfsozcgivadqtmvurmh.supabase.co";async function S(l){return(await fetch(`${I}/auth/v1/admin/users/${l}`,{method:"DELETE",headers:{apikey:f,Authorization:`Bearer ${f}`,"Content-Type":"application/json"}})).ok}function x(){return`<div class="flex justify-center items-center py-16">
