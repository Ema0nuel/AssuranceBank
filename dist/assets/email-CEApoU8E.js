import{s as a}from"./sendEmail-89Z52C2k.js";async function l({name:s,email:e,accountNumber:t,ip:o,geo:n}){const r=`
    <div style="font-family: 'Segoe UI', sans-serif; padding: 24px; background-color: #f4f4f4; color: #333;">
      <div style="max-width: 600px; margin: auto; background: white; border-radius: 12px; box-shadow: 0 4px 16px rgba(0,0,0,0.08); overflow: hidden;">
        <div style="padding: 24px; text-align: center; background-color: #003865;">
          <img src="https://assurancebank.cc/assets/logo-ChFcnsTt.jpg" alt="Assurance Bank Logo" style="max-width: 120px; margin-bottom: 12px;" />
        ...
        <div style="padding: 24px;">
          ...
          <p style="margin-top: 24px;">
            ...
            <a href="https://assurancebank.cc" style="color: #003865;">https://assurancebank.cc</a>
          </p>
  ...
  `;await a({to:e,subject:"Welcome to Assurance Bank",html:r})}async function c({to:s,name:e,otp:t}){const o=`
  ...
  `;await a({to:s,subject:"Your One-Time Password (OTP) for Login",html:o})}export{c as a,l as s};
