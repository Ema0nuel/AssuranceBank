import{n as t}from"./navbar-BIr1TaOR.js";import{f as s}from"./footer-DE4WXhqK.js";import{s as o}from"./toast-DRvdR0y9.js";import{r as i}from"./reset-CYKpHJhn.js";import"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";const f=()=>{i("Personal Enquiry");function n(){t().pageEvents?.();const e=document.getElementById("personalEnquiryForm");e&&e.addEventListener("submit",async r=>{r.preventDefault();const a=Object.fromEntries(new FormData(e));if(!a.firstName||!a.lastName||!a.phone||!a.email||!a.postcode){o("Please fill in all required fields.","error");return}try{e.querySelector('button[type="submit"]').disabled=!0,await new Promise(l=>setTimeout(l,1200)),o("Your enquiry has been submitted!","success"),e.reset()}catch{o("Failed to submit. Please try again.","error")}finally{e.querySelector('button[type="submit"]').disabled=!1}})}return{html:`
      ${t().html}
          ...
          <div class="max-w-2xl mx-auto px-4">
            ...
            <form id="personalEnquiryForm" class="space-y-4 bg-white dark:bg-brand-dark rounded-lg shadow p-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <option selected>Select option</option>
                    ...
                    <option value="I want to switch my loan over to Assurance Bank">I want to switch my loan over to Assurance Bank</option>
              ...
              <div class="text-xs text-brand-gray dark:text-brand-light mt-2">
                We collect your personal information in order to respond to your enquiry and contact you; your personal information may be shared within the Group. This includes subsidiaries, related companies, agencies and franchises. To request access to your personal information, please contact your <a href="/locate" data-nav class="text-brand-sun hover:underline">nearest branch</a> or <a href="mailto:assurancebankcc@gmail.com" class="text-brand-sun hover:underline">assurancebankcc@gmail.com</a>. For more information, please read our <a href="/privacy" data-nav class="text-brand-sun hover:underline">Privacy Policy</a>.
              </div>
      ...
      ${s().html}
    `,pageEvents:n}};export{f as default};
