import{n as i}from"./navbar-BIr1TaOR.js";import{f as t}from"./footer-DTbUeEss.js";import{r as s}from"./reset-CYKpHJhn.js";import"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";const d=()=>{const e=i();s("Financial Difficulty Assistance");function a(){e.pageEvents()}return{html:`
      ${e.html}
        ...
        <section class="py-4 border-t border-brand-grape/20" id="Apply">
          <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="md:col-span-2">
              ...
              <p class="mb-4"><strong>Mortgage Help Centre<br></strong>Email: <a href="mailto: assurancebank@gmail.com" class="text-brand-sun underline"> assurancebank@gmail.com</a></p>
            </div>
          </div>
        </section>
