import{n as l}from"./navbar-BIr1TaOR.js";import{r as c}from"./reset-CYKpHJhn.js";import{s as o}from"./toast-DRvdR0y9.js";import{a as m,e as u}from"./spinner-bKIlGSde.js";import{s as f}from"./supabaseClient-BzAKCqO5.js";import{N as b}from"./logo-nobg-UuYbhWoI.js";import{L as p}from"./logo-B-uS21Zh.js";const L=()=>{c("Forgot Password");const i=l();function d(){i.pageEvents?.();const s=document.getElementById("forgot-form"),a=document.getElementById("email"),e=s?.querySelector('button[type="submit"]');a&&a.addEventListener("input",r=>{const t=/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(r.target.value);a.style.borderColor=t?"":"rgb(239, 68, 68)",e&&(e.disabled=!t)}),s&&s.addEventListener("submit",async r=>{r.preventDefault();const t=a.value.trim();if(!t||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))return;e.disabled=!0,e.innerHTML='<i class="fas fa-spinner fa-spin"></i> Sending...',m();const{error:n}=await f.auth.resetPasswordForEmail(t,{redirectTo:"https://assurancebank.com/reset-password"});u(),n?(o(n.message||"Failed to send reset instructions","error"),e.disabled=!1,e.innerHTML='Send Instructions <i class="fas fa-paper-plane text-sm"></i>'):(o("Password reset instructions sent to your email","success"),setTimeout(()=>window.location.href="/login",2e3))})}return{html:`
          ...
          <div class="w-full max-w-md space-y-8">
            <div class="flex flex-col items-center mb-6">
              <a href="/" data-nav class="flex items-center justify-center mb-4">
                <img src="${b}" alt="Assurance Bank logo" class="h-16 w-auto block dark:hidden" />
                <img src="${p}" alt="Assurance Bank logo" class="h-16 w-auto hidden dark:block" />
              </a>
    ...
    `,pageEvents:d}};export{L as default};
