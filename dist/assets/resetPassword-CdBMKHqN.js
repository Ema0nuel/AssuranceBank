          ...
          <div class="w-full max-w-md space-y-8">
            <div class="flex flex-col items-center mb-6">
              <a href="/" data-nav class="flex items-center justify-center mb-4">
                <img src="${v}" alt="Assurance Bank logo" class="h-16 w-auto block dark:hidden" />
                <img src="${w}" alt="Assurance Bank logo" class="h-16 w-auto hidden dark:block" />
              </a>
