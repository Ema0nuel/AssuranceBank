import{n as t}from"./navbar-BIr1TaOR.js";import{f as a}from"./footer-DTbUeEss.js";import{r as i}from"./reset-CYKpHJhn.js";import{N as s}from"./logo-nobg-UuYbhWoI.js";import{L as n}from"./logo-B-uS21Zh.js";const m=()=>{const e=t();i("Privacy Policy");function o(){e.pageEvents()}return{html:`
      ${e.html}
      <main id="mainContent" class="main fullWidthPage bg-brand-light dark:bg-brand-dark text-brand-navy dark:text-brand-light" data-pg="FullWidthPage">
          ...
          <div class="relative z-10 max-w-5xl mx-auto px-4 py-12 flex flex-col md:flex-row items-center">
            <div class="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p class="text-white text-lg">Assurance Bank<br>
                <a href="mailto:assurancebank@gmail.com" class="underline">assurancebank@gmail.com</a> &nbsp;|&nbsp; <a href="tel:+447529555635" class="underline">+447529555635</a>
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="py-8">
          <div class="max-w-5xl mx-auto px-4">
            ...
            <p>Email: <a href="mailto:assurancebank@gmail.com" class="underline">assurancebank@gmail.com</a><br>
