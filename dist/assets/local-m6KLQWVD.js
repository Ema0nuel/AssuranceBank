import{s as m}from"./supabaseClient-BzAKCqO5.js";import{n as N}from"./Navbar-pMjcO_a8.js";import{s as r}from"./toast-DRvdR0y9.js";import{r as $}from"./reset-CYKpHJhn.js";import{N as A}from"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";const L=["E9876567","G0876578","8767898H","K2387651","456L7890","1M234567","987654N3","O2345678","98765P43","Q1987654","R7654321","567S1234","T3456789","876543U1","V1234567","345678W9","X2345678","9Y876543","Z3456781","234567A8","B3456781","123456C7","D2345678","876E5432","5678F123","6789G123","7890H234","8901I345","9012J456","0123K567","K4561237","L5672348","M6783459","N7894560","O8905671","P9016782","Q0127893","R1238904","S2349015","T3450126","U4561237","V5672348","W6783459","X7894560","Y8905671","Z9016782","A0127893","B1238904","C2349015","D3450126","E4561237","F5672348","G6783459","H7894560","I8905671","J9016782","K0127893","L1238904","M2349015","N3450126","O4561237","P5672348","Q6783459","R7894560","S8905671","T9016782","U0127893","V1238904","W2349015","X3450126","Y4561237","Z5672348","A6783459","B7894560","C8905671","D9016782","E0127893","F1238904","G2349015","H3450126","I4561237","J5672348","K6783459","L7894560","M8905671","N9016782","O0127893","P1238904","Q2349015","R3450126","S4561237","T5672348","U6783459","V7894560","W8905671","X9016782","Y0127893","Z1238904","A2349015","B3450126","C4561237","D5672348","E6783459","F7894560","G8905671","H9016782","I0127893","J1238904","K2349015","L3450126","M4561237","N5672348","O6783459","P7894560","Q8905671","R9016782","S0127893","T1238904","U2349015","V3450126","W4561237","X5672348","Y6783459","Z7894560","A8905671","B9016782","C0127893","D1238904","E2349015","F3450126","G4561237","H5672348","I6783459","J7894560","K8905671","L9016782","M0127893","N1238904","O2349015","P3450126"];function P(){return Math.floor(1e5+Math.random()*9e5).toString()}async function S(){try{return await(await fetch("https://ipapi.co/json/")).json()}catch{return{}}}function y(a={}){const e={...{title:"Local Transfer Receipt",receiptId:v(),date:new Date().toLocaleDateString(),time:new Date().toLocaleTimeString(),amount:"0.00",currency:"$",description:"Local Transfer",senderName:"",recipientName:"",bankName:"",accountNumber:"",transactionType:"Local Transfer",status:"Pending",referenceNumber:"",fees:"0.00",totalAmount:"",companyName:"Assurance Bank",companyAddress:"123 Main St, City, Country",companyPhone:"+1 (555) 123-4567",companyEmail:"assurancebankcc@gmail.com",additionalFields:{},showFooter:!0,footerText:"Thank you for banking with us!"},...a};if(!e.totalAmount){const o=parseFloat(e.amount)||0,n=parseFloat(e.fees)||0;e.totalAmount=(o+n).toFixed(2)}return`
    <div class="receipt-container font-mono">
      <div class="text-center mb-4">
        <img src="${A}" alt="Assurance Bank" class="h-10 mx-auto mb-2" />
      ...
      ${Object.keys(e.additionalFields).length>0?`<div class="mb-4 border-t border-dashed border-gray-300 dark:border-gray-700 pt-3">
                ${Object.entries(e.additionalFields).map(([o,n])=>`
                      <div class="flex justify-between text-xs mb-1">
    ...
    `}function v(){const a=Date.now().toString().slice(-6),l=Math.random().toString(36).substr(2,4).toUpperCase();return`RCP-${a}-${l}`}function x(a,l){let e=document.getElementById("code-modal");e||(e=document.createElement("div"),e.id="code-modal",document.body.appendChild(e)),e.className="",e.innerHTML=`
  ...
  `,document.getElementById("close-code-modal").onclick=()=>{e.innerHTML="",e.className="hidden"},document.getElementById("code-form").onsubmit=async function(o){o.preventDefault();const n=this.code.value.trim();L.includes(n)?(e.innerHTML="",e.className="hidden",l()):r("Invalid code. Please contact support.","error")}}function I(){let a=document.getElementById("success-modal");a||(a=document.createElement("div"),a.id="success-modal",document.body.appendChild(a)),a.className="",a.innerHTML=`
  ...
  `;const e=document.getElementById("success-canvas").getContext("2d");let o=0;function n(){e.clearRect(0,0,120,120),e.lineWidth=6,e.strokeStyle="#16a34a",e.beginPath(),e.arc(60,60,48,Math.PI*.5,Math.PI*(2*o),!1),e.stroke(),o<1?(o+=.03,requestAnimationFrame(n)):(e.beginPath(),e.moveTo(40,65),e.lineTo(55,80),e.lineTo(85,45),e.strokeStyle="#16a34a",e.lineWidth=8,e.stroke())}n(),document.getElementById("close-success-modal").onclick=()=>{a.innerHTML="",a.className="hidden",window.location.reload()}}const O=async()=>{$("Assurance Bank | Local Transfer");const a=N(),l=await m.auth.getSession();if(!l.data.session){window.location.href="/login";return}const{user:e}=l.data.session,{data:o}=await m.from("profiles").select("*").eq("id",e.id).single();let{data:n}=await m.from("accounts").select("*").eq("user_id",e.id).single();const g=p=>typeof p=="number"?p.toLocaleString("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2}):p||"$0.00";function h(){a.pageEvents?.(),document.getElementById("local-transfer-form").onsubmit=async function(t){t.preventDefault();try{const s=parseFloat(this.amount.value),c=this.bankname.value.trim(),d=this.accountName.value.trim(),i=this.accountNum.value.trim(),u=this.desc.value.trim();if(!s||!c||!d||!i||!u){r("All fields are required.","error");return}if(s<=0){r("Amount must be greater than zero.","error");return}if(s>n.balance){r("Insufficient balance.","error");return}r("Sending OTP...","info");const f=P(),b=await S(),{error:k}=await m.from("otps").insert([{user_id:e.id,code:f,type:"local",expires_at:new Date(Date.now()+10*6e4).toISOString()}]);if(k){r("Database error. Please try again.","error");return}p({amount:s,bankname:c,accountName:d,accountNum:i,desc:u,profile:o,account:n,otp:f,ipLoc:b}),fetch("/api/send-email",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:e.email,subject:"Your OTP for Local Transfer",html:`
              <h2>Local Transfer OTP</h2>
              <p>Your OTP is: <b>${f}</b></p>
              <p>IP: ${b.ip||"N/A"}<br>
      ...
      `,document.getElementById("close-otp-modal").onclick=()=>{s.innerHTML="",s.className="hidden"},document.getElementById("otp-form").onsubmit=async function(c){c.preventDefault();const d=this.otp.value.trim(),{data:i,error:u}=await m.from("otps").select("*").eq("user_id",t.profile.id).eq("code",d).eq("type","local").order("created_at",{ascending:!1}).limit(1).single();if(u||!i||new Date(i.expires_at)<new Date){r("Invalid or expired OTP.","error");return}w(t)}}function w(t){let s=document.getElementById("otp-modal");s.className="",s.innerHTML=`
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300">
          <div class="receipt-modal-content bg-white dark:bg-gray-900 rounded-xl shadow-2xl w-full max-w-md mx-2 p-0 relative overflow-auto" style="max-height:90vh;">
            ...
            <div class="p-6">
              ${y({id:v(),date:new Date().toLocaleDateString(),time:new Date().toLocaleTimeString(),amount:t.amount,currency:"$",description:t.desc,senderName:t.profile.full_name,recipientName:t.accountName,bankName:t.bankname,accountNumber:t.accountNum,transactionType:"Local Transfer",status:"Pending",referenceNumber:t.accountNum,fees:"0.00",totalAmount:t.amount,additionalFields:{IP:t.ipLoc.ip||"N/A",Location:`${t.ipLoc.city||""}, ${t.ipLoc.region||""}, ${t.ipLoc.country_name||""}`}})}
      ...
      `,document.getElementById("close-receipt-modal").onclick=()=>{s.innerHTML="",s.className="hidden"},document.getElementById("complete-local-btn").onclick=()=>{x("IMF",()=>{x("COT",()=>{x("VAT",async()=>{I();try{const c=parseFloat(t.amount),d=parseFloat(t.account.balance),i=d-c;await m.from("accounts").update({balance:i}).eq("id",t.account.id);const{data:u,error:f}=await m.from("transactions").insert([{account_id:t.account.id,user_id:t.profile.id,type:"local",description:t.desc,amount:c,balance_before:d,balance_after:i,status:"pending"}]).select().single();await m.from("notifications").insert([{user_id:t.profile.id,title:"Local Transfer Initiated",message:`Your local transfer of ${g(t.amount)} to ${t.accountName} is awaiting admin approval.`,type:"info",read:!1}]),fetch("/api/send-email",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({to:t.profile.email,subject:"Local Transfer Receipt",html:y({amount:t.amount,senderName:t.profile.full_name,recipientName:t.accountName,bankName:t.bankname,accountNumber:t.accountNum,description:t.desc,fees:"0.00",status:"Pending",referenceNumber:u?.id||v(),companyName:"Assurance Bank",companyAddress:"123 Main St, City, Country",companyPhone:"+1 (555) 123-4567",companyEmail:"assurancebankcc@gmail.com"})})})}catch{r("Failed to process transaction. Please try again.","error")}})})})}}}return{html:`
      <div class="relative">
        ${a.html}
            ...
            <div class="p-4">
              <div class="mb-4">
                <nav class="flex items-center space-x-2 text-xs">
                  ...
                  <span class="text-gray-700 dark:text-gray-300">Local Transfer</span>
                </nav>
              </div>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="p-4 rounded bg-green-100 dark:bg-green-900 transition-all hover:shadow text-xs">
                  <div class="flex items-center justify-between">
                    <div>
                      <h3 class="text-base font-semibold text-green-800 dark:text-green-300">${g(n?.balance)}</h3>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="p-6 rounded bg-white dark:bg-gray-800 shadow-sm">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4"><i class="fa fa-bank mr-2"></i> Local Fund Transfer</h3>
                  <form id="local-transfer-form" class="space-y-4">
    ...
    `,pageEvents:h}};export{O as default};
