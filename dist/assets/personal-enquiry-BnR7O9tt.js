          ...
          <div class="max-w-2xl mx-auto px-4">
            ...
            <form id="personalEnquiryForm" class="space-y-4 bg-white dark:bg-brand-dark rounded-lg shadow p-6">
              ...
              <div class="text-xs text-brand-gray dark:text-brand-light mt-2">
                We collect your personal information in order to respond to your enquiry and contact you; your personal information may be shared within the Group. This includes subsidiaries, related companies, agencies and franchises. To request access to your personal information, please contact your <a href="/locate" data-nav class="text-brand-sun hover:underline">nearest branch</a> or <a href="mailto:assurancebank@gmail.com" class="text-brand-sun hover:underline">assurancebank@gmail.com</a>. For more information, please read our <a href="/privacy" data-nav class="text-brand-sun hover:underline">Privacy Policy</a>.
              </div>
