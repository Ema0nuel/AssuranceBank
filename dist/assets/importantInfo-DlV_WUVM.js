import{n as a}from"./navbar-BIr1TaOR.js";import{f as n}from"./footer-DTbUeEss.js";import{r as s}from"./reset-CYKpHJhn.js";import{N as l}from"./logo-nobg-UuYbhWoI.js";import{L as r}from"./logo-B-uS21Zh.js";const o=[{title:"Codes of practice",icon:"fa-solid fa-scale-balanced",details:`
    ...
    `,link:"/",linkText:"Learn more about our codes of practice"},{title:"Disclosure documents",icon:"fa-solid fa-file-lines",details:`
      <p>Access all Assurance Bank disclosure documents, including:</p>
      <ul>
    ...
    `,link:"/",linkText:"View our disclosure documents"},{title:"Financial Claims Scheme (FCS)",icon:"fa-solid fa-shield-halved",details:`
    ...
    `,link:"/",linkText:"Learn more about FCS"},{title:"Privacy",icon:"fa-solid fa-user-shield",details:`
      <p>Learn how we manage personal and credit related information through our:</p>
      <ul>
        <li>Assurance Bank Privacy Policy</li>
        <li>Credit Reporting Policy</li>
        <li>Credit Reporting Statement of Notifiable Matters</li>
        <li>Consumer Data Right</li>
      </ul>
    `,link:"/",linkText:"View our policies"},{title:"Target Market Determinations (TMD)",icon:"fa-solid fa-bullseye",details:`
      <p>Target Market Determinations for financial products distributed by Assurance Bank are to ensure that the right products end up in the hands of the right customer. We do this by focusing on our customers in the design and distribution of our financial products.</p>
    `,link:"/",linkText:"Learn more about TMDs"},{title:"Website terms of use",icon:"fa-solid fa-globe",details:`
      <p>The terms of use for the Assurance Bank website sets the rules for using our website with our rights in, and restrictions on your use of, the site, product and services information, third party content and jurisdiction.</p>
        ...
        <section class="relative w-full min-h-[320px] md:min-h-[440px] flex items-center bg-gradient-to-br from-brand-sun/80 to-brand-navy/90">
          ...
          <div class="relative z-10 max-w-5xl mx-auto px-4 py-12 flex flex-col md:flex-row items-center">
            <div class="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
              <img src="${l}" alt="Assurance Bank" class="h-16 w-auto mb-4 block dark:hidden" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ${o.map(e=>`
                <div class="rounded-xl shadow-lg bg-white dark:bg-brand-dark border border-brand-sun/20 p-6 flex flex-col transition-all duration-300 group h-full">
                  ...
                  <a href="/" data-nav class="btn btn-outline-primary px-4 py-2 rounded-full border-2 border-brand-sun text-brand-sun hover:bg-brand-sun hover:text-white transition mt-auto">${e.linkText}</a>
                </div>
              `).join("")}
            </div>
          </div>
