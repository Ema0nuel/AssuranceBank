import{n as t}from"./navbar-BIr1TaOR.js";import{f as i}from"./footer-DE4WXhqK.js";import{r as n}from"./reset-CYKpHJhn.js";import{N as s}from"./logo-nobg-UuYbhWoI.js";import{L as r}from"./logo-B-uS21Zh.js";const u=()=>{const e=t();n("Target Market Determinations");function a(){e.pageEvents()}return{html:`
      ${e.html}
        ...
        <section class="pt-0 pb-8">
          <div class="max-w-5xl mx-auto px-4 flex flex-col md:flex-row gap-8">
            ...
            <div class="flex-1 bg-brand-light dark:bg-brand-dark border rounded-xl p-6">
              <p>This page includes the Target Market Determinations for financial products issued and/or distributed by Assurance Bank.</p>
            </div>
          </div>
        </section>
      </main>
      ${i().html}
    `,pageEvents:a}};export{u as default};
