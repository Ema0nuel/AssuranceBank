import{n as s}from"./navbar-BIr1TaOR.js";import{f as t}from"./footer-DE4WXhqK.js";import{r as n}from"./reset-CYKpHJhn.js";import"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";const c=()=>{const a=s();n("Personal");function e(){a.pageEvents()}return{html:`
      ${a.html}
      <main id="mainContent" class="main fullWidthPage bg-brand-light dark:bg-brand-dark text-brand-navy dark:text-brand-light" data-pg="FullWidthPage">
            ...
            <div>
              ...
              <div class="mb-2">
                ...
                <div id="accordion-content" class="hidden bg-white dark:bg-brand-dark rounded p-4 mt-2">
                  <p>Desperate for a holiday? Or to dive into an adventure? Driven to buy your next car? Or dreaming of a home makeover? Or home comforts? A Assurance Bank personal loan can make it happen. Applying online is quick and easy. Here's how it works. To be eligible, you need to be over 18, a US citizen or permanent resident, employed, or have a regular income, not bankrupt or in financial hardship. If you receive government benefits, it's best to call us.</p>
        ...
        <section class="bg-brand-sun/20 py-8">
          <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex-1">
              <h3 class="text-2xl font-bold text-brand-navy dark:text-brand-sun mb-2">Looking to switch your personal loan to Assurance Bank?</h3>
            </div>
            <div>
