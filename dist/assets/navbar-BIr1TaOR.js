import{N as c}from"./logo-nobg-UuYbhWoI.js";import{L as u}from"./logo-B-uS21Zh.js";function g(){const o=localStorage.getItem("theme"),s=window.matchMedia("(prefers-color-scheme: dark)").matches,t=o||(s?"dark":"light");document.documentElement.classList.toggle("dark",t==="dark");const a=document.createElement("button");return a.setAttribute("aria-label","Toggle Theme"),a.className=`
        ...
        <nav class="sticky top-0 z-40 w-full bg-brand-light dark:bg-brand-dark border-b border-brand-gray dark:border-brand-navy shadow-sm font-sans" style="font-family: 'DM Sans', 'Roboto', sans-serif; font-size: 12px;">
          <div class="max-w-7xl mx-auto flex items-center justify-between px-4 py-2">
            <a href="/" data-nav class="flex items-center gap-2">
              <img src="${c}" alt="Assurance Bank logo" class="h-8 w-auto block dark:hidden" />
              <img src="${u}" alt="Assurance Bank logo" class="h-8 w-auto hidden dark:block" />
              <span class="font-bold text-base text-brand-navy dark:text-brand-sun ml-2">Assurance Bank</span>
            </a>
