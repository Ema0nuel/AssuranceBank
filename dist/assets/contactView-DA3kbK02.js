import{n as o}from"./navbar-BIr1TaOR.js";import{f as m}from"./footer-DE4WXhqK.js";import{s as t}from"./toast-DRvdR0y9.js";import{r as c}from"./reset-CYKpHJhn.js";import"./logo-nobg-UuYbhWoI.js";import"./logo-B-uS21Zh.js";const r="assurancebankcc@gmail.com",l="+1210279-5532",h=()=>{c("Contact Us");function d(){o().pageEvents?.();const e=document.getElementById("contactForm");e&&e.addEventListener("submit",async s=>{s.preventDefault();const n=Object.fromEntries(new FormData(e));if(!n.name||!n.email||!n.message){t("Please fill in all required fields.","error");return}try{e.querySelector('button[type="submit"]').disabled=!0,await new Promise(i=>setTimeout(i,1200)),t("Your message has been sent!","success"),e.reset()}catch{t("Failed to send message. Please try again.","error")}finally{e.querySelector('button[type="submit"]').disabled=!1}});const a=document.getElementById("prevContactForm");a&&a.addEventListener("submit",s=>{s.preventDefault(),t("Form submitted (demo only)","info"),a.reset()})}return{html:`
      ${o().html}
        ...
        <section class="relative w-full min-h-[320px] md:min-h-[440px] flex items-center bg-gradient-to-br from-brand-sun/80 to-brand-navy/90">
          ...
          <div class="relative z-10 max-w-5xl mx-auto px-4 py-12 flex flex-col md:flex-row items-center">
            <div class="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
              <h1 class="text-3xl md:text-5xl font-extrabold text-white dark:text-brand-sun mb-4 drop-shadow-lg">Contact Assurance Bank</h1>
      ...
      ${m().html}
    `,pageEvents:d}};export{h as default};
